...
record Album(int Id, string Title, string Artist, double Price, string Image_url)
{
     public static List<Album> GetAll(){
         var albums = new List<Album>(){
            ...
            new Album(7, "Npact's Greatest Hits", "Amazing", 500.00, "https://d3v0px0pttie1i.cloudfront.net/uploads/organization/logo/9138563/35b0412c.jpg"),
            new Album(8, "Man U","Mid Table", 7000000000, "https://static.wikia.nocookie.net/logopedia/images/8/86/Manchester_United_FC_logo_%282D%29.svg")
         };
